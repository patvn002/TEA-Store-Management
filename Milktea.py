'''
File : Milktea.py
Description : This is the inherited Milktea module from BubbleTea 
              class and contains all the import and the methods to calculate 
              the MilkTea price and also dislplay it to the screen.
Author : Vraj Patel
...
# MilkTea does not have the add fruit method as it is not a Fruit Tea
...
class MilkTea(BubbleTea):
    ...
    def calculate_price(self, top_pricing):
        ...
        return bprice + 0.29 + price + price_of_flavour + price_of_toppings
